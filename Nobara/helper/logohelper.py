...
font=ImageFont.truetype("Nobara/fonts/IronFont.otf",110)
...
def Gabung(fun):
    def gabung(arg):
        ...
        # Load font
        font_path = "./Nobara/fonts/default.ttf"  # Replace with your font's path
        font_size = 120
...
def generate(text1, text2):
    # Load the font
    font_path = "./Nobara/fonts/default.ttf"  # Update this to the correct font path
...
def blackpink(teks):
    ...
    font_path = "./Nobara/fonts/blackpink.otf"  # Update this to the correct font path
    font_size = 120  # Adjust font size as needed
    font = ImageFont.truetype(font_path, font_size)
