...
from Nobara.database.lockdb import (
    set_lock,
    unset_lock,
    get_locks,
)
from Nobara.database.approve_db import is_user_approved
from Nobara.helper.user import is_user_admin
from Nobara import ptb , LOCK_GROUP
from Nobara.helper.handler import MultiCommandHandler
from Nobara.helper.lock_helper import LOCK_CHAT_RESTRICTION, LOCKABLES, UNLOCK_CHAT_RESTRICTION
