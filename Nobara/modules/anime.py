...
from Nobara.anime.data_parser import (
    get_all_genres,
    get_all_tags,
    get_studio_animes,
    get_studios,
...
from Nobara.anime.helper import (
    clog,
    check_user,
    get_btns,
    rand_key,
...
from Nobara.anime.db import get_collection
...
async def auto_unpin(client: Client, cq: CallbackQuery):
    ...
    if data:
        ...
        cancel = True
    if cancel:
        return await cq.answer(f"𝖯𝗅𝖾𝖺𝗌𝖾 𝖾𝗇𝖺𝖻𝗅𝖾 {srcname} 𝖺𝗇𝖽 𝖠𝗎𝗍𝗈 𝖯𝗂𝗇 𝗈𝗉𝗍𝗂𝗈𝗇 𝖿𝗈𝗋 𝗍𝗁𝖾𝗆!!!", show_alert=True)
    setting = None
    if qry=="call":
        pass
    elif qry == "None":
