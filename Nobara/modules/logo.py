...
from Nobara.vars import LOGO_LINKS
from pyrogram.enums import ParseMode
import os
from Nobara.helper.logohelper import generate , blackpink
...
async def generate_logo(client, message):
    try:
        ...
        fnt_files = glob.glob("./Nobara/fonts/*")  # Update to your font directory
        if not fnt_files:
