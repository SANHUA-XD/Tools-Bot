...
from TianXiwei.Functions.on_start import save_restart_data
...
async def restart_command(client, message):
    try:
        restart_message = await message.reply("**ᴏɴɪɪ-ᴄʜᴀɴ TianXiwei ɪꜱ ʙᴇɪɴɢ ʀᴇꜱᴛᴀʀᴛᴇᴅ !!**")
        save_restart_data(restart_message.chat.id, restart_message.id)
        os.execvp(sys.executable, [sys.executable, "-m", "TianXiwei"])
