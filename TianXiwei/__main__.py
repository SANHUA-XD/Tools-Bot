...
import hashlib
import random
from TianXiwei.Functions.link_share import decode_chat_id
...
def load_modules_from_folder(folder_name):
    ...
    for filename in os.listdir(folder_path):
        if filename.endswith(".py") and filename != "__init__.py":
            ...
            module = importlib.import_module(f"TianXiwei.{folder_name}.{module_name}")
...
def get_main_menu_buttons():
    buttons = [
        ...
        [
            InlineKeyboardButton("🆘 ʜᴇʟᴘ 🆘", callback_data="template_help"),
...
@app.on_callback_query(filters.regex(r"^template_help$"))
