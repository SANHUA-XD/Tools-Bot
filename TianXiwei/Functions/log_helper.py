import asyncio
from TianXiwei.Database.log_channel_db import get_log_channel
from TianXiwei import app, scheduler
...
# Registered at import time (same pattern as TianXiwei/admin/backup.py's own
