...
from TianXiwei.Database.blacklistdb import (
...
from TianXiwei import app , BLACKLIST_GROUP
from pyrogram.enums import ParseMode
from pyrogram import types 
import time
import re
from TianXiwei.Extra.chatadmin import chatadmin , can_restrict_members
from config import config 
from TianXiwei.Database.warn_db import add_warn , MAX_WARNS
...
async def take_action(client: Client, message: Message, blacklist_mode: dict):
    try:
        ...
        if mode == "del":
            ...
            await message.reply(f"{message.from_user.mention} 𝗁𝖺𝗌 𝖻𝖾𝖾𝗇 𝗍𝖾𝗆𝗉𝗈𝗋𝖺𝗋𝗂𝗅𝗒 𝗆𝗎𝗍𝖾𝖽 𝖿𝗈𝗋 {duration} 𝗌𝖾𝖼𝗈𝗇𝖽𝗌 𝖿𝗈𝗋 𝗎𝗌𝗂𝗇𝗀 𝖻𝗅𝖺𝖼𝗄𝗅𝗂𝗌𝗍𝖾𝖽 𝖼𝗈𝗇𝗍𝖾𝗇𝗍.")
